...
const system = `The user will provide all the relevant files in the following format
<context>
<folder folderName="The name of the folder with extension">
...
<task>
The task the user has to you involving that file
</task>
No need to tell the user what have you changed, he will look at the files.
If you provide a file that does not exist it will be created.
You must reply with only the files that must be changed in the full path, using the same xml pattern.
`
